                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    @foreach($listMenu as $menu)
                        ...
                        @if(isset($menu['type']) && $menu['type'] === 'divider')
                            ...
                            @continue
                        @endif
                        {{-- Jika tipe Logout (Butuh Form POST biar aman) --}}
                        @if(isset($menu['type']) && $menu['type'] === 'logout')
                            <form method="POST" id="logout-form-dropdown">
                                @csrf
                                <a class="dropdown-item text-danger" href="#" onclick="event.preventDefault(); document.getElementById('logout-form-dropdown').submit();">
                                    <i class="mdi {{ $menu['icon'] }} font-size-16 align-middle me-2"></i>
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ $menu['url'] }}">
                            ...
                            {{-- Jika ada Badge --}}
                            @if(isset($menu['badge']))
                                <span class="badge {{ $menu['badge']['class'] }} ms-auto">
                                    {{ $menu['badge']['text'] }}
                                </span>
                            @endif
                        </a>
